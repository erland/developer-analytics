...
public class ActivityApplicationService {
    ...
    @Transactional
    public ActivityResult get(UUID userId, LocalDate from, LocalDate to,
                              String search, String ownership, String visibility,
                              List<String> selectedProjectTypes, List<String> technologiesFilter) {
    ...
    private ActivityResult emptyResponse() {
        return new ActivityResult(0, 0, 0.0, 0.0, 0, 0, null, null,
